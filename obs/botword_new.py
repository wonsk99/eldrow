...
# Keyboard stuff
KEYS = []
KEYS.append(list("Q  W  E  R  T  Y  U  I  O  P"))
KEYS.append(list(" A  S  D  F  G  H  J  K  L"))
KEYS.append(list("   Z  X  C  V  B  N  M"))

## END GLOBALS ##

# Connect to Discord
client = disc.Client(intents=disc.Intents.all())
